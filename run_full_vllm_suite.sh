#!/bin/bash
# Complete vLLM benchmark suite for comparison report
...
echo "=========================================="
echo "vLLM Complete Benchmark Suite"
echo "=========================================="
...
python analyze_cache_warmup.py --results-dir results > results/cache_analysis.txt
...
echo ""
echo "=========================================="
echo "✓ vLLM Benchmark Suite Complete!"
echo "=========================================="
echo ""
echo "Results saved in:"
echo "  - results/benchmark_report.md"
echo "  - results/cache_analysis.txt"
echo "  - results/*.png"
echo ""
echo "Next steps:"
echo "1. Review results: cat results/benchmark_report.md"
echo "2. Switch to SGLang server"
echo "3. Run: ./run_full_sglang_suite.sh"
echo "4. Compare results: python compare_frameworks.py"
